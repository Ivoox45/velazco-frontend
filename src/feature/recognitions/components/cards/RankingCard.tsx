    ...
    >
      ...
      <div className="flex gap-12 font-semibold text-lg">
        ...
        {area === "cajeros" && (
          <>
            <div className="text-green-500 text-right">
              <span className="text-xl font-semibold">{data.pedidos}</span>
              <p className="font-normal text-xs text-gray-500">Pedidos</p>
            </div>
            <div className="text-blue-600 text-right">
              <span className="text-xl font-semibold">
                S/.{data.total?.toLocaleString()}
              </span>
              <p className="font-normal text-xs text-gray-500">Total</p>
            </div>
          </>
        )}
